...
class Network:
    def __init__(self, NUM_NODES, NUM_PRIORITY_LEVELS=1, SEED=4, NUM_TIERS=3, TIER_HEIGHT=100, TIER_WIDTH=20,
                 DC_CAPACITY_UNIT=50, DC_COST_UNIT=50, LINK_BW_LB=100, LINK_BW_UB=150, LINK_COST_LB=10,
                 LINK_COST_UB=20, BURST_SIZE_LIMIT=50, PACKET_SIZE=10):
